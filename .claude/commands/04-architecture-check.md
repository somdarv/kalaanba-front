---
description: Stage 4 — architecture review for a Work Packet (architect).
argument-hint: <WP-id>
---

Delegate to the **architect** subagent (Task tool). Review Work Packet $1.
...
Output the **Architecture Review** block defined in the architect subagent.
