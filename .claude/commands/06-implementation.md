---
description: Stage 6 — implement a Work Packet against approved contracts (implementer).
argument-hint: <WP-id>
---

Delegate to the **implementer** subagent (Task tool). Implement Work Packet $1.
...
Then implement, including tests scaffolded for the QA Engineer stage. Cite each file you touched, and run the implementer post-flight gates before claiming done.
