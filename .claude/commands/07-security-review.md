---
description: Stage 7 — privacy and abuse review of an implementation (security-reviewer).
argument-hint: <WP-id>
---

Delegate to the **security-reviewer** subagent (Task tool). Review the implementation for Work Packet $1.
...
Output the Security Review block defined in the subagent. End with **APPROVED** or **BLOCKING ISSUES**.
