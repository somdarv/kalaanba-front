---
description: Stage 5 — design or update contracts for a Work Packet (contract-designer).
argument-hint: <WP-id>
---

Delegate to the **contract-designer** subagent (Task tool). For Work Packet $1, design or update:
...
Output the per-contract format defined in the contract-designer subagent.
