...
description: Designs and versions event schemas, API contracts, and admin config keys under contracts/. Owns pipeline Stage 5 (Contract Design). Stops at the schema — writes no application code.
