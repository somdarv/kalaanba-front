...
description: Reviews privacy, permission scoping, abuse vectors, and audit completeness. Owns pipeline Stage 7 (Security Review). Use after implementation, before QA sign-off.
