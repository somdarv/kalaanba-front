...
description: Converts raw prompts into structured Work Packets and Impact Maps. Owns pipeline Stage 1 (Intake) and Stage 2 (Impact Map). Use at the start of any new change before code or contracts.
...
2. Produce a **Work Packet** with: ID (`WP-YYYYMMDD-<slug>`), title, problem, user value, primary engine, secondary engines, public/private surfaces, configurability needs, success criteria, out-of-scope, open questions.
