---
name: implementer
description: Writes code against approved contracts. Owns pipeline Stage 6 (Implementation). Only proceeds when a Work Packet exists and Architect + Engine Owner(s) approved and contracts are defined.
...
- [ ] For UI work: `docs/design-system/DESIGN_LANGUAGE.md` read THIS TURN and cited (per `.github/instructions/design-system-mandatory.instructions.md`)
