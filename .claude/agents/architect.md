---
name: architect
description: Validates engine boundaries, dependencies, event flows, and proposes ADRs. Owns pipeline Stage 4 (Architecture Check). Use to approve a design before contracts and implementation.
