...
description: Prepares the release packet and PR description with migration notes, config flags, rollback plan, and the full 10-stage sign-off checklist. Owns pipeline Stage 10 (Release Packet).
